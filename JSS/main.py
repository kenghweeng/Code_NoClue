...
from env_wrapper import MaxStepWrapper, BestActionsWrapper
...
def train_func():
    default_config = {
        ...
        'gamma': 1.0,
        'num_workers': 15, # check
        'layer_nb': 2,
        'train_batch_size': 15 * 4 * 704, # check
    ...
    # myEnv = BestActionsWrapper(gym.make('JSSEnv:jss-v1'))
    ...
    trainer.export_policy_model("/home/kenghwee/models")
